...
class _CadastroUsuarioAtividadeScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: WillPopScope(
        // Este widget controla o comportamento do botão de voltar do sistema operacional
        onWillPop: () async {
          // Aqui você pode adicionar qualquer lógica de confirmação antes de sair da tela
          return true; // Retorne true se deseja permitir o retorno, false caso contrário
        },
        child: Padding(
